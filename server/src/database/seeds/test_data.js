exports.seed = async function (knex) {
  ...
  await knex('clients').insert([
    ...
    { id: 4, name: 'Client r', clientKey: '9dc0d129-e36b81cb7754e61663cc508221a20d1a6e9d72b85f7d96ff', clientSecret: '38612790263db835b90021a2464f205abdd0d75c13335c83' },
  ]);
  ...
  await knex('processors').insert([
    { id: 1, name: 'Stripe 1', url: 'domain.com', apiKey: '38612790263db835b90021a2464f205abdd0d75c13335c83', processorType: 1 },
    { id: 2, name: 'Stripe 2', url: 'domain.com', apiKey: '38612790263db835b90021a2464f205abdd0d75c13335c83', processorType: 1 },
    { id: 3, name: 'Processor 3', url: 'domain.com', apiKey: '38612790263db835b90021a2464f205abdd0d75c13335c83', processorType: 1 },
    { id: 4, name: 'Some other', url: 'domain.com', apiKey: '38612790263db835b90021a2464f205abdd0d75c13335c83', processorType: 1 },
  ]);
